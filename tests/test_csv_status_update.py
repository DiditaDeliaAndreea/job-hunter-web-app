...
def test_update_job_status_in_csv_updates_verification_status(tmp_path, monkeypatch):
    ...
    csv_path.write_text(
        'Job Title,Company,Location,Posted Date,Working Type,Salary,Fit Score (%),Match Reasons,Job Description,Recommended CV,CV Tailoring Recommendation,Status,URL,Listing Source,Official Listing Verified,Official Listing URL,Original Listing URL,URL Check Status,User Dismissed,Applied,User Status Override,Verification Status,Verification Notes,Last Verified\n'
